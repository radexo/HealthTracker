# Create Electron configuration files for Windows desktop app

# 1. Package.json for Electron app
package_json = {
    "name": "healthtracker-2025",
    "version": "1.0.0", 
    "description": "Профессиональное приложение для отслеживания показателей тела, тренировок и здоровья",
    ...
    "build": {
        ...
        "productName": "HealthTracker 2025",
        "copyright": "Copyright © 2025 HealthTracker Team",
        "directories": {
            "output": "dist",
            "resources": "assets"
        },
        ...
        "win": {
            ...
            "publisherName": "HealthTracker Team",
        ...
        "portable": {
            "artifactName": "HealthTracker-2025-Portable-${version}-${arch}.${ext}"
        },
        "publish": {
            "provider": "generic",
            "url": "https://github.com/healthtracker/releases"
        }
    }
}
...
print("✅ package.json создан для Electron приложения")

# 2. Main Electron process file
...
print("✅ main.js создан с полной поддержкой SQLite")